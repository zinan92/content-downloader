...
- [ ] **ADAPT-01**: 抖音 adapter — 单条视频 URL 下载（去水印 + 封面 + metadata）
- [ ] **ADAPT-02**: 抖音 adapter — profile URL 批量下载（支持 post/like/collection 模式）
- [ ] **ADAPT-03**: 抖音 adapter — 短链接自动解析（v.douyin.com → 完整 URL）
